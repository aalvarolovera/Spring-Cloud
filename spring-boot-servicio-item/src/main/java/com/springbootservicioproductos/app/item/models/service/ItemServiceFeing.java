 package com.springbootservicioproductos.app.item.models.service;
...
import com.springbootservicioproductos.app.item.clientes.ProductoClienteRest;
import com.springbootservicioproductos.app.item.models.Item;
...
public class ItemServiceFeing implements ItemService{
	...
	public List<Item> findAll() {
		return clienteFeing.lista().stream().map(p -> new Item(p, 1)).collect(Collectors.toList());
	}
